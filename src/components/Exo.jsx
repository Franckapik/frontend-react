...
export const Exo = ({ exercice: exo, setPointsEva, setCompsEva }) => {
  ...
  const { data: questions, isSuccess: isQuestioning } = useQuery("questions" + exo.id, () =>
    fetch(`https://strapi.eva-svt.ovh/api/questions?populate=*&filters[exercice]=` + exo.id).then((res) => res.json())
  );
  ...
  return (
    <div className="card m-3 has-background-light is-shadowless">
      <div className="card-content">
        <div className={papier !== null ? `is-underlined card-header mb-4  is-shadowless` : `card-header m-3 p-3`}>
